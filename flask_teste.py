...
# configurações MYSQL
app.config['MYSQL_HOST'] = '________' #Coloque seu hostname
app.config['MYSQL_USER'] = '________'  #coloque seu username
app.config['MYSQL_PASSWORD'] = '______'  #coloque sua senha
